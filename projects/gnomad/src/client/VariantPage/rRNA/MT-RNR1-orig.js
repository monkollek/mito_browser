...
class Rrna1Orig extends React.Component{
    ...
    componentDidMount(){
        ...
        for(var t of allText){
            if(t.innerHTML==variant){
                ...
                circle.setAttribute('r',10*multi);
    ...
    render() {
        return(
            <svg id="svg-container" style={{position:'absolute', backgroundColor:'white'}} height="310" width="300" xmlns="http://www.w3.org/2000/svg">
                <rect x="0" y="0" width="300" height="310" style={{fill: 'none',strokeWidth:'1',stroke:'black'}}></rect>
