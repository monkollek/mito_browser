...
class Rrna2Orig extends React.Component{
    ...
    componentDidMount(){
        ...
        for(var t of allLines){
            ...
            if(t.getAttribute('stroke-width')==2){
                t.setAttribute('stroke-width',2*multi);
            } else {
                t.setAttribute('stroke-width',1*multi); 
            }
            t.setAttribute('stroke-linecap',"round");
            var newX1 = (parseInt(t.getAttribute('x1'))+30)*multi
            var newY1 = parseInt(t.getAttribute('y1'))*multi
            var newX2 = (parseInt(t.getAttribute('x2'))+30)*multi
        ...
        for(var t of allCircles){
            ...
            var newX = (parseInt(t.getAttribute('cx'))+30)*multi;
        ...
        for(var t of allText){
            t.setAttribute('font-size', 14*multi);
            t.setAttribute('fill', '#000000');
            t.setAttribute('font-family', 'monospace');
            t.setAttribute("text-anchor", "middle"); 
            t.setAttribute("dominant-baseline", "middle"); 
            var newX = (parseInt(t.getAttribute('x'))+30)*multi;
        ...
        var allText = svgnode.getElementsByTagName('title');
        for(var t of allText){
            if(t.innerHTML==variant){
                var textNode = t.parentElement;
                textNode.setAttribute('font-weight',"700");
                textNode.setAttribute('font-size',16*multi);
                ...
                circle.setAttribute('r',16*multi);
                circle.setAttribute('fill','yellow');
                svgnode.insertBefore(circle, svgnode.childNodes[1]);

                //add rectangle for zoom
                var rect = document.createElementNS('http://www.w3.org/2000/svg','rect');
                rect.setAttribute('x',newX-220*multi);
                rect.setAttribute('y',newY-220*multi);
                rect.setAttribute('width',440*multi);
                rect.setAttribute('height',440*multi);
                rect.setAttribute('fill','none');
                rect.setAttribute('stroke-width','1');
                rect.setAttribute('stroke','black');
                svgnode.insertBefore(rect, svgnode.childNodes[2]);
    ...
    render() {
        return(
            <svg id="svg-container" style={{position:'absolute', backgroundColor:'white'}} height="300" width="500" xmlns="http://www.w3.org/2000/svg">
                <rect x='0' y='0' height='300' width='500' fill='none' strokeWidth='1' stroke='black'></rect>
